-- Test const behavior (and mutable by default)

print("Testing const/mutable behavior...")
...
-- Test 1: Reassign implicit local (should SUCCEED now)
succeeds("a = 1; a = 2", "reassign implicit")

-- Test 2: Reassign loop variable (should SUCCEED now)
succeeds("for i=1,10 do i=5 break end", "reassign loop var")

-- Test 3: Reassign parameter (should SUCCEED now)
succeeds("function f(x) x=2 end; f(1)", "reassign parameter")

-- Test 4: Const variable reassignment (should FAIL)
