...
if rows[1].content != "hello world" then
    error("Query returned wrong content: " .. tostring(rows[1].content))
end
...
if not string.find(err, "no such table") and not string.find(err, "Generic error") then 
