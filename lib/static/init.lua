...
shellout_uname = shellout("uname -s")
if shellout_uname == nil then
	shellout_uname = "Unknown"
end
UNAME = string.match(shellout_uname, "%a+")
if UNAME == nil then
	UNAME = "Unknown"
end
link_with_libdl = ""
...
loaders_table = package.loaders
if loaders_table == nil then
	loaders_table = package.searchers
end
table.insert(loaders_table, 2, lua_loader)
