...
Global_State :: struct {
	...
	ud:         rawptr,
	totalbytes: c.size_t,
	// ... other fields will be added when lstate is migrated
}
...
// Free memory block
freemem :: #force_inline proc(L: ^State, g: ^Global_State, block: rawptr, size: c.size_t) {
	realloc_(L, g, block, size, 0)
}

// Allocate new memory block
malloc :: #force_inline proc(L: ^State, g: ^Global_State, size: c.size_t) -> rawptr {
